      ...
      <section className="bg-black text-white px-6 pt-24 pb-16">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="font-serif leading-relaxed text-xl md:text-2xl font-bold opacity-90 mb-8">
            ...
            <span className="bg-yellow-300 text-black px-1 mx-1 font-serif font-bold">「武器」</span>
            を提供するための有志プロジェクトです。
          </p>
          <p className="font-sans leading-loose text-base md:text-lg opacity-80">
      ...
      <div className="px-4 md:px-8 max-w-3xl mx-auto">
        ...
        <section className="pt-20 pb-16 border-t-4 border-black mt-8">
          <div className="mb-16">
            ...
            <h2 className="font-sans font-black leading-none tracking-tighter text-black text-3xl md:text-4xl">
              立ちはだかる<br />
          ...
          <div className="flex flex-col gap-16">
            ...
            <div className="relative">
              ...
              <div className="relative z-10 pt-4">
                <h3 className="font-sans font-black text-2xl text-black mb-3 border-b-2 border-black inline-block pb-1">
                  作業量の壁
                </h3>
                <p className="font-sans font-bold text-lg leading-[1.8] text-gray-800">
        ...
        <section className="py-16 border-t-4 border-black">
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex items-start border-l-4 border-black pl-4">
              ...
              <div>
                <h3 className="font-sans font-black text-xl text-black mb-2 uppercase tracking-widest">
                  要約 / Summary
                </h3>
                <p className="font-sans font-bold text-base leading-[1.8] text-gray-800">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col gap-10">
              <div>
                ...
                <p className="font-sans text-base leading-[1.8] text-gray-300">
        ...
        <section className="py-16 px-4 md:px-8 max-w-3xl mx-auto">
          <div className="border-4 border-black p-6 md:p-10 bg-white">
            ...
            <p className="font-sans font-bold leading-[1.8] text-black text-sm mb-8">
