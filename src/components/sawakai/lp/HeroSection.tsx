    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          ...
          className="absolute top-[-10%] left-[-10%] w-[60vw] h-[60vw] md:w-[40vw] md:h-[40vw] rounded-full bg-emerald-100/50 blur-3xl"
        />
        <motion.div
          animate={{ x: [0, -40, 50, 0], y: [0, 40, -30, 0], scale: [1, 0.8, 1.15, 1] }}
          transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-[-10%] right-[-10%] w-[70vw] h-[70vw] md:w-[50vw] md:h-[50vw] rounded-full bg-teal-100/40 blur-3xl"
        />
      </div>
      ...
      >
        <motion.div
          ...
          className="space-y-4"
        >
          <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 tracking-wide leading-[1.1]">
            日常の「モヤモヤ」を、<br className="hidden md:block"/>公共のアジェンダへ。
          </h1>
